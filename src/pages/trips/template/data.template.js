...
export const TRIP_ID = "YOUR_TRIP_ID_HERE"; // 例如 "2026-tokyo"
...
// 素食溝通卡（用於 總覽 Tab）
// 若無素食需求可移除此匯出與 App.jsx 中的 VegetarianCard 元件
export const vegetarianCard = {
  restriction:
    "肉・魚介類・鶏肉・豚肉・牛肉・エキスなど、動物性食品は一切食べられません。",
  dashi: "※ カツオや煮干しなどの魚介ダシ、動物性ブイヨンも不可です。",
  question:
    "この料理には、肉や魚介類、それらのダシ（カツオエキス等）は含まれていますか？",
  ok: "野菜、卵、乳製品、大豆製品、昆布ダシ、椎茸ダシは食べられます。",
  canEat: [
    "野菜全般",
    "卵",
    "牛乳・チーズ",
