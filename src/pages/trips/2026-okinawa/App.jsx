 ...
 *
 * 主題色為莫蘭迪鼠尾草綠 (#0284c7)；若要換主題，
 * 全域搜尋替換 #0284c7 / #0369a1 / #f0f9ff / #0c4a6e 即可。
 * ============================================================
 */
    ...
    <div className="mb-4 last:mb-0">
      ...
      >
        <div className="flex items-center gap-2">
          <h4 className="font-bold text-[#0369a1]">{title}</h4>
          {count !== undefined && (
...
const StationMappingCloud = ({ stations }) => {
  ...
  return (
    <div className="bg-white/40 rounded-xl p-2.5">
          ...
          <button
            ...
            className={`w-full px-1 py-2 rounded-xl text-xs font-bold transition-all duration-300 ${
              selectedStation === i
                ...
                : "bg-white text-[#0284c7] border border-[#0284c7]/20 hover:bg-[#0284c7]/5 hover:shadow-sm"
            }`}
          >
      ...
      >
        {selectedStation !== null && (
          <div className="bg-white/80 rounded-xl border border-[#0284c7]/10 flex items-center gap-3 p-3">
            <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[#0284c7]/10 flex items-center justify-center">
              <Train size={14} className="text-[#0284c7]" />
            </div>
...
const ProductModal = ({ isOpen, onClose, product }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative bg-[#f0f9ff] rounded-3xl max-w-sm w-full shadow-2xl overflow-hidden animate-fade-up"
      ...
      >
        ...
        <div className="p-6">
          <h3 className="text-xl font-bold text-[#0369a1] mb-2">
            {product.name}
          </h3>
          {product.nameJp && (
            <p className="text-sm text-[#0284c7] mb-3">🇯🇵 {product.nameJp}</p>
          )}
          {product.desc && (
...
export default function App() {
  ...
  return (
    <div className="min-h-screen text-[#1C1C1E] selection:bg-[#38bdf8]/20 selection:text-[#0284c7] relative bg-[#e0f2fe] overflow-x-clip">
            ...
            <div className="bg-white/40 backdrop-blur-md rounded-xl p-4 border border-white/40 shadow-sm">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                ...
                <div className="flex flex-col items-start sm:items-end gap-0.5 mt-2 sm:mt-0">
                  <div className="flex items-baseline gap-2">
                    <span className="text-xl font-bold text-[#0284c7] tabular-nums">
                      ¥
                      {Math.round(
                  ...
                  <div className="flex items-baseline gap-1 text-[11px]">
                    ...
                    <span className="font-semibold text-[#0284c7] tabular-nums">
                      ¥
                      {Math.round(
              ...
              <div className="mt-4 pt-4 border-t border-[#0369a1]/10">
                <button
                  onClick={() => setShowBreakdown(!showBreakdown)}
                  className="inline-flex items-center gap-1 text-xs text-[#0284c7] hover:text-[#0369a1] transition-colors font-semibold"
                >
                ...
                {showBreakdown && (
                  <div className="mt-3 p-4 bg-[#f0f9ff]/80 rounded-xl space-y-2.5 border border-[#0369a1]/10 animate-fade-in">
                    <div className="text-xs font-bold text-[#0369a1] pb-1.5 border-b border-[#0369a1]/20 flex justify-between">
                      <span>日期與地點</span>
                      <span>計算依據與房價</span>
                    </div>
                    {accommodationBreakdown.map((item, bIdx) => (
                      <div
                        key={bIdx}
                        className="flex justify-between items-center text-xs text-gray-600 py-1.5 last:pb-0 border-b border-[#0369a1]/10 last:border-0"
                      >
                        <div className="flex flex-col sm:flex-row sm:items-center">
                          <span className="font-semibold text-[#0284c7] sm:mr-1.5">
                            {item.period}
                          </span>
            ...
            {accommodationData.map((section, idx) => {
              ...
              return (
                <SectionCard
                  ...
                  title={
                    <div className="flex items-center gap-3 w-full">
                      <span className="w-[72px] text-center inline-block text-xs font-medium text-[#0284c7] bg-[#0284c7]/10 px-2.5 py-0.5 rounded-full flex-shrink-0">
                        {parsedDate.day}
                      </span>
                ...
                >
                  <div>
                    {parsedDate.date && (
                      <div className="inline-flex items-center gap-1.5 text-xs text-[#0284c7] bg-[#0284c7]/5 px-3 py-1 rounded-xl border border-[#0284c7]/10 mb-4">
                        <Calendar size={12} />
                      ...
                      {section.hotels.map((hotel, hIdx) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <h4 className="font-bold text-[#0369a1] text-lg pr-16 mb-1">
                              {hotel.name}
                            </h4>
                            ...
                            <div className="flex items-center justify-between mt-3 pt-3 border-t border-[#0369a1]/10">
                              {hotel.mapUrl ? (
                                <a
                                  href={hotel.mapUrl}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="inline-flex items-center gap-1 text-xs text-[#0284c7] hover:text-[#0369a1] transition-colors font-medium bg-white px-2 py-1 rounded shadow-sm hover:shadow-md"
                                >
                                  <MapPin size={12} /> 查看地圖
                                </a>
                              ) : (
                    ...
                    <div>
                      {parsedDate.date && (
                        <div className="flex flex-wrap items-center gap-2 mb-4">
                          <div className="inline-flex items-center gap-1.5 text-xs text-[#0284c7] bg-[#0284c7]/5 px-3 py-1 rounded-xl border border-[#0284c7]/10">
                            <Calendar size={12} />
                      ...
                      {route.options && (
                        <div className="flex gap-2 mb-4 bg-[#f0f9ff] p-1 rounded-2xl border border-[#0369a1]/10">
                        ...
                        {steps &&
                          steps.map((step, sIdx) => {
                            ...
                            return (
                              <div
                                key={sIdx}
                                className="bg-[#f0f9ff]/80 rounded-2xl p-3.5 flex flex-col gap-1.5 border border-[#0369a1]/10 relative overflow-hidden group transition-all duration-300 hover:shadow-sm"
                              >
                                {/* 裝飾線條 */}
                                <div
                                ...
                                <div className="flex items-center gap-1.5 border-b border-[#0369a1]/10 pb-1.5 mb-1 pl-2">
                                  <div className="flex items-center gap-1.5 min-w-0 flex-1">
                                    ...
                                    <div className="flex items-center gap-2 flex-wrap">
                                      ...
                                      {step.duration && (
                                        <span className="ml-auto text-[11px] text-[#0369a1] font-medium flex items-center gap-0.5 opacity-80 shrink-0">
                                          <Clock size={10} />
                                          {step.duration}
                                        </span>
                                      )}
                                ...
                                {(step.fare || step.note) && (
                                  <div className="text-[11px] text-gray-600 mt-2 leading-snug bg-white/60 p-2.5 rounded-lg border border-white/45 pl-3 ml-2 flex flex-col gap-1">
                                    {step.fare && (
                                      <div className="text-xs text-[#0284c7] font-bold flex items-start gap-1">
                                        <Ticket
                                          size={12}
                                    ...
                                    {step.timetable && (
                                      <div className="mt-2.5 mb-2 bg-white/80 rounded-xl overflow-hidden border border-[#0284c7]/20 shadow-sm">
                                        <table className="w-full text-[11px] md:text-xs text-center">
                                          <thead className="bg-[#0284c7]/10 text-[#0284c7] font-bold">
                                            <tr>
                                          ...
                                          <tbody className="divide-y divide-[#0284c7]/10">
                                            {step.timetable.map((row, rIdx) => (
                                              <tr
                                                key={rIdx}
                                                className="hover:bg-[#0284c7]/5 transition-colors"
                                              >
                                    ...
                                    {step.link && (
                                      <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center gap-1 text-[#0284c7] hover:text-[#0369a1] underline font-medium mt-1 transition-colors"
                                      >
                                        🔗 {step.link.text}
                                      </a>
                                    )}
          ...
          >
            {attractionData.categories.map((category, cIdx) => {
              ...
              return (
                ...
                >
                  {parsedDate.date && (
                    <div className="inline-flex items-center gap-1.5 text-xs text-[#0284c7] bg-[#0284c7]/5 px-3 py-1 rounded-xl border border-[#0284c7]/10 mb-4 ml-2">
                      <Calendar size={12} />
                      <span className="font-medium">{parsedDate.date}</span>
                    </div>
                  )}
                    ...
                    >
                      <div className="space-y-2">
                        {section.items.map((item, iIdx) => (
                          <div
                            key={iIdx}
                            className="p-3 rounded-xl transition-colors bg-white/70 backdrop-blur-sm hover:bg-white border border-transparent hover:border-[#0284c7]/10"
                          >
                            <div className="flex items-start gap-3">
                              <div className="flex-1 min-w-0 pt-1 pl-2">
                                <div className="font-bold text-[#0369a1] flex items-center gap-2">
                                  {item.name}
                                </div>
                                ...
                                {item.fee && (
                                  <div className="mt-1.5 text-[11px] text-[#0284c7] font-bold flex items-start gap-1">
                                    <Ticket
                                      size={12}
                                      className="mt-0.5 shrink-0"
                                    />
                                ...
                                {item.note && (
                                  <div className="text-xs text-gray-500 mt-2 pl-2.5 border-l-2 border-[#0284c7]/35 leading-relaxed">
                                    {item.note}
                                  </div>
                                )}
                              </div>
                              {item.mapUrl && (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="p-2 text-gray-400 hover:text-[#0284c7] transition-colors shrink-0"
                                >
                                  <MapPin size={16} />
                                </a>
                              )}
                                  ...
                                  <div
                                    ...
                                    className={`p-3 rounded-xl transition-colors ${
                                      isFavorite
                                        ...
                                        : "bg-white/70 backdrop-blur-sm hover:bg-white border border-transparent hover:border-[#0284c7]/10"
                                    }`}
                                  >
                                    <div className="flex items-start gap-3">
                                      <button
                                      ...
                                      <div className="flex-1 min-w-0 pt-1">
                                        <div className="font-bold text-[#0369a1] whitespace-pre-wrap leading-tight">
                                          {item.name}
                                        </div>
                                        <div className="text-xs text-gray-500 mt-1">
                                          <span className="text-[#E86B50] font-bold tracking-wide">
