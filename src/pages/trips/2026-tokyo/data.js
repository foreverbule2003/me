...
export const shoppingData = {
  ...
  wishlist: [
    {
      name: "IPSA 美膚微整機能液 (流金水)",
      nameJp: "ザ・タイムR アクア",
      desc: "日本超人氣保濕神仙水，強效補水、改善粉刺閉口，使肌膚水嫩透亮。",
      price: 4400,
      category: "美妝",
      shop: "松本清 / 澀谷百貨公司",
    ...
    {
      name: "Saborino 早安面膜 (經典保濕型)",
      nameJp: "サボリーノ 目ざまシート",
      desc: "起床後敷上 60 秒，洗臉、保養、隔離一步搞定，上妝超服貼。",
      price: 1430,
      category: "美妝",
      shop: "唐吉訶德 / 松本清",
    ...
    {
      name: "Suisai 淨透酵素洗顏粉",
      nameJp: "スイサイ ビューティクリア パウダーウォッシュ",
      desc: "溫和去角質、清除黑頭粉刺，單顆包裝旅行攜帶超便利。",
      price: 1980,
      category: "美妝",
      shop: "松本清 / 藥妝店",
    ...
    {
      name: "CANMAKE 完美高效眼影",
      nameJp: "キャンメイク パーフェクトスタイリストアイズ",
      desc: "高性價比開架眼影，粉質細緻服貼，經典大地色系超百搭。",
      price: 858,
      category: "彩妝",
      shop: "松本清 / PLAZA",
    ...
    },
    {
      name: "FEILER 經典織花手帕",
      nameJp: "フェイラー ハンカチ",
      desc: "德國百年品牌，在日本極受歡迎的雪尼爾織花手帕，送禮自用極佳。",
      price: 2750,
      category: "精品",
      shop: "澀谷百貨公司 / 銀座旗艦店",
    ...
    {
      name: "Press Butter Sand 焦糖夾心餅乾",
      nameJp: "プレスバターサンド",
      desc: "東京超人氣伴手禮！雙層烤焦糖與香濃奶油內餡，口感層次豐富。",
      price: 1800,
      category: "零食",
      shop: "東京站 / 百貨公司地庫",
      image: "https://images.unsplash.com/photo-1558961303-1d20210a2e41?q=80&w=400&auto=format&fit=crop",
    }
  ],
};
