...
const ToolsView = ({ onSetActions }) => {
    ...
    const menuItems = [
        { label: '財務儀表板', href: '/me/tools/financial-dashboard.html', isExternal: true },
        { label: '期權策略模擬器', href: '/me/tools/bull-put-spread.html', isExternal: true },
        ...
        <>
            ...
            {isEmailModalOpen && (
                ...
                >
                    ...
                    >
                        <h3 className="font-bold border-b-2 border-[#0f380f] mb-2 pb-1">CONTACT EMAIL</h3>
                        <p className="font-mono text-sm break-all mb-6">foreverbule2003@gmail.com</p>
                        <div
