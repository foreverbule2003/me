...
const AppContent = () => {
    ...
    return (
        ...
        >
            <Routes>
                <Route path="/" element={<HomeView onSetActions={handleSetActions} />} />
                <Route path="/about" element={<AboutView onSetActions={handleSetActions} />} />
                <Route path="/trips" element={<TripsView onSetActions={handleSetActions} />} />
                <Route path="/journal" element={<JournalView onSetActions={handleSetActions} onLoadState={handleLoadState} />} />
                <Route path="/tools" element={<ToolsView onSetActions={handleSetActions} />} />
            </Routes>
        </GameBoyShell>
    );
};
