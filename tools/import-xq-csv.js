...
if (!fs.existsSync(csvPath)) {
    ...
    console.log('Please export data from XQ and save as .csv in the project root.');
    process.exit(1);
}
...
const finalOutput = Array.from(historyMap.values()).sort((a, b) => a.date.localeCompare(b.date));
