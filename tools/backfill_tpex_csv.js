    ...
    const req = https.get(
      url,
      {
        headers: {
          ...
          Referer:
            "https://www.tpex.org.tw/zh-tw/bond/info/statistics-cb/day.html",
        },
      },
      (res) => {
...
async function runBackfill(days = 10) {
  ...
  fs.writeFileSync(
    "tools/tpex_backfill_10days.json",
    JSON.stringify(results, null, 2),
  );
  console.log(
    `[Done] Saved ${results.length} total records to tools/tpex_backfill_10days.json`,
  );
}
