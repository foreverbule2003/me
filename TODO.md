...
> 最後更新：2026-01-24 (Post-P1-Migration)
...
- [x] **Hot CB UI / Reliability (Phase 2)**: 實作市場與自選雙頁籤、週末 Firebase 自動備援機制、隱藏第三方來源標籤、並優化行動端 RWD 顯示。 ✅ (Completed: 2026-01-24)

- [x] **Serverless Migration (Phase 1)**: 成功透過 GitHub Actions 實作全自動化雲端爬蟲與 Firestore 同步，完全擺脫本地開發機依賴。✅ (Completed: 2026-01-24)
